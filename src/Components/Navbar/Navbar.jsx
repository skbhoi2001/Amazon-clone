...
import SearchBar from "./SearchBar";
  ...
  const handleX = () => {
    ...
    const getDrawerChoices = () => {
      return isAuth?isAuthTrue.map(({ label, href }) => {
        return (
          <Link
            {...{
    ...
    const Amazonlogo = (
      <Typography variant="h6" component="h1" className={logo}>
        <img style={{width:"100px",height:"30px"}}  src="https://www.freepnglogos.com/uploads/amazon-png-logo-vector/large-images-amazon-png-logo-vector-7.png3ft3d1416935166817" />
      </Typography>
    );
