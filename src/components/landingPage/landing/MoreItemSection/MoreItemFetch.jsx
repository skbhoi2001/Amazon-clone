...
export const MoreItemFetch = ()=>{
    ...
    const getData = async ()=>{
        try {
            const response = await axios.get(`https://serpapi.com/search.json?engine=walmart&query=vitamins&api_key=adf094f424eaf9d4a30af607e33833c06f551834dc546131c8125fff0876d7e9`)
