...
export const MostSeller = ()=>{
    ...
    const getData = async ()=>{
        try {
            const response = await axios.get(`https://serpapi.com/search.json?engine=walmart&query=jeans&api_key=553a91d893834e300d0fd9775fb2c67c180c04ebabdca991027c948cc595cce2`)
